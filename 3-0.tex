...
\begin{figure}
  ...
  \begin{tabbing}
   ...
   \langle \ldots, a,e,b,\ldots\ldots\rangle$.}\\
    ...
    \>\>$a':=\Id{friListe}.\Id{først}$\>\comment{Skaf ny knude $a'$ til at indeholde $x$,}\\
...
\index{liste!fzrst@\Id{først}}
\index{liste!sidst@\Id{sidst}}
...
\index{række!adgang@adgang $[{}\cdot{}]$|textbf}
\begin{align*}
...
\index{kø!først@\Id{først}|textbf}
