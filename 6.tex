...
(b) \Id{sigtOp}$(n)$ har udførelsestid $O(\log n)$.
...
Operationerne \Id{tilføj} og \Id{fjernMindste} gennemløber en del af vejen fra roden til et blad og har derform logaritmisk udførelsestid.
...
Den totale udførelsestid for  \Id{opbyg} er derfor asymptotisk begrænset af
\[
