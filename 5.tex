...
Ved analysen af udførelsestiden af kviksortering på input\-følge
...
Med udgangspunkt i antal sammenligninger er de andre andre operationers bidrag til den samled  udførelsestid kun konstante faktorer og additive termer.
...
Figur~\lref{alg:LSDsort} viser udgaven af grundtalssortering for nøgler i området $\{0,\ldots, K^d-1\}$, med udførelsestid $O(d(n+K))$.
