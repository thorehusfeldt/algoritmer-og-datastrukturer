...
I afsnit~\llabel{s:array} skal vi betragte \emph{ubegrænsede} (også kaldt \emph{dynamiske}) rækker,
\index{ubegrænset række}
\index{række!ubegrænset}
\index{række!dynamisk}
...
Selvom den slags relativ adgang kan simuleres med indicerede rækker, skal vi i afsnit~\lref{s:list} introducere en mere fleksibel repræsentation i form af hægtede lister.
...
Forgængeren til attrapknuden~$h$ indeholder følgens sidste indgang $e_n$, se figur~\lref{alg:ditem}.
...
Alle grundlæggende listeoperationer bruger grundoperationen \emph{splejs},
...
\begin{figure}
  \begin{tabbing}
   ...
   \langle \ldots, a,e,b,\ldots\ldots\rangle$.}\\
    ...
    \>\>$\Id{sikrFriListe}$\hspace{2cm}\=\comment{Sikr at $\Id{friListe}$ ikke er tom. Se opg. 3.3.}\\
  ...
  Flere konstanttidsoperationer på dobbelthægtede lister til klassen fra figur~\lref{alg:dlist1}.}
\end{figure}
...
\index{vogterknude|textbf}
 ...
 \end{quote}
  ...
  \begin{exerc}[Lagerhåndtering.]
    ...
    Angiv en implementation af funktionen $\Id{sikrFriListe}$, som kaldes fra $\Id{indsætEfter}$, som angivet i figur~\lref{alg:dlist2}.
...
I begge tilfælde gælder ligningen $n=\frac{1}{2}w$ efter udførelsen af \Id{reallocate}; 
