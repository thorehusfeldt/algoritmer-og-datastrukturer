...
En graf $G'= (V', E')$ er en \emph{delgraf} af grafen $G=(V,E)$, hvis $V'\subseteq V$ og $E'\subseteq E$.
...
En urettet graf er et \emph{træ}, hvis der mellem hvert par af knuder findes netop én vej; fx som i fig.~2.8.
En urettet graf er en \emph{skov}, hvis der mellem hvert par af knuder findes højst én vej.
